...
class Attention_UNet_Encoder(nn.Module):
    def __init__(self, params):
        super(Attention_UNet_Encoder, self).__init__()
        self.params = params
...
class Attention_UNet_Decoder(nn.Module):
    def __init__(self, params):
        super(Attention_UNet_Decoder, self).__init__()
        self.params = params
        self.is_deconv = self.params['is_deconv']
        self.feature_scale = self.params['feature_scale']
        nonlocal_mode = self.params['nonlocal_mode']
        attention_dsample = self.params['attention_dsample']
        is_batchnorm = self.params['is_batchnorm']
...
class Attention_UNet_2dual(nn.Module):
    ...
    def __init__(self, feature_scale=4, n_classes=21, is_deconv=True, in_channels=3,
        ...
        super(Attention_UNet_2dual, self).__init__()

        params = {'feature_scale': feature_scale,
                  'n_classes': n_classes,
                  'is_deconv': is_deconv,
        ...
        self.encoder = Attention_UNet_Encoder(params)
        self.main_decoder = Attention_UNet_Decoder(params)
        self.aux_decoder1 = Attention_UNet_Decoder(params) #辅助分支
