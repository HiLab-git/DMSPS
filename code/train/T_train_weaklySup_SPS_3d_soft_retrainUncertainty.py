...
parser.add_argument('--trainData', type=str,
                    default='trainT01.txt', help='Data name, select mode for Abdomen: word, BTCV')
...
parser.add_argument('--ES_tterval', type=int,
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            if iter_num > 0 and iter_num % 200 == 0:
                ...
                model.eval()
                # metric_list = test_all_case_cct(
                #     model, args.root_path, test_list=args.validData, num_classes=num_classes, patch_size=args.patch_size,
