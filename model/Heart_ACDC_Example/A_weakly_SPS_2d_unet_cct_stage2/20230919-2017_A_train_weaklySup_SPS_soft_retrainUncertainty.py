...
parser.add_argument('--trainData', type=str,
                    default='trainT01.txt', help='retrain Data')
...
parser.add_argument('--max_iterations', type=int,
                    default=30000, help='maximum epoch number to train')#原来是和60000,abdomen是100k
parser.add_argument('--batch_size', type=int, default=24,
                    help='batch_size per gpu')#原来是6
...
def train(args, snapshot_path):
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            outputs_soft2 = torch.softmax(outputs_aux1, dim=1)#按照类别即通道数c进行softmax
            ...
            if iter_num % 100 == 0:
                ...
                #hard
                # pseudo_supervision_show = pseudo_supervision[1,...].unsqueeze(0) * 30
                # writer.add_image('train/pseudo_label',pseudo_supervision_show,iter_num)
                #soft
                # pseudo_supervision_show = soft_pseudo_label[1,...].unsqueeze(0) * 30
                # writer.add_image('train/pseudo_label',pseudo_supervision_show,iter_num)
